...
let arrayForSeperatesText = [];


function abstand () {

    for (let index = 0; index < (text.length); index += 100) {
        let sliceText = text.slice(0 + index, 99 + index);
        arrayForSeperatesText.push(sliceText);

    }

    console.log(arrayForSeperatesText);
}
